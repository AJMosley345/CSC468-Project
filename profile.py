...
tourDescription = \
"""
This profile is a base for the project to test on
"""
...
for i in range(num_nodes):
  ...
  if i == 0:
    node.addService(pg.Execute(shell="sh", command="sudo bash /local/repository/install_scripts/kube_manager.sh"))
  else:
