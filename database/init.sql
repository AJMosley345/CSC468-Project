CREATE USER 'remote'@'webui' IDENTIFIED WITH mysql_native_password BY 'test1234';
GRANT CREATE, ALTER, DROP, INSERT, UPDATE, DELETE, SELECT, REFERENCES, RELOAD on *.* TO 'remote'@'webui' WITH GRANT OPTION;
...
VALUES
    -- INSERT into student with student_id 1
    (1, 2),
    (1, 3),
    (1, 23),
    (1, 15),
    -- INSERT into student with student_id 2
    (2, 2),
    (2, 23),
    (2, 15),
    (2, 19),
    -- INSERT into student with student_id 3
    (3, 12),
    (3, 31),
    (3, 16),
    (3, 5),
    -- INSERT into student with student_id 4
    (4, 12),
    (4, 23),
    (4, 26),
    (4, 11),
    -- INSERT into student with student_id 5
    (5, 18),
    (5, 32),
    (5, 25),
    (5, 28);
...
VALUES
    -- INSERT into professor with professor_id 1
    (1, 2),
    (1, 3),
    (1, 23),
    (1, 15),
    -- INSERT into professor with professor_id 2
    (2, 2),
    (2, 23),
    (2, 15),
    (2, 19),
    -- INSERT into professor with professor_id 3
    (3, 12),
    (3, 31),
    (3, 16),
    (3, 5),
    -- INSERT into professor with professor_id 4
    (4, 12),
    (4, 23),
    (4, 26),
    (4, 11);
