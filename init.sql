CREATE USER 'remote'@'172.20.0.11' IDENTIFIED BY 'test123';
GRANT CREATE, ALTER, DROP, INSERT, UPDATE, DELETE, SELECT, REFERENCES, RELOAD on *.* TO 'remote'@'172.20.0.11' WITH GRANT OPTION;
